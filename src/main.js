...
const ccLogoCard = document.querySelector(".card-logo-img")
...
const expirationDatePattern = {
  ...
  blocks: {
    YY: {
      ...
      from: String(new Date().getFullYear() - 2).slice(2),
...
function updateExperationDate(date) {
  const ccExtra = document.querySelector(".cc-extra .cc-expiration .value")
